...
<body>
   ...
   <div class="form-container">
      ...
      <form action="" method="post">
         ...
         <input type="text" name="name" required placeholder="Nhập username" class="box">
         <input type="email" name="email" required placeholder="Nhập email" class="box">
         <input type="password" name="password" required placeholder="Nhập password" class="box">
         <input type="password" name="cpassword" required placeholder="Nhập lại password" class="box">
